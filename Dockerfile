...
COPY moesifapi-java moesifapi-java
COPY moesif-servlet-debug moesif-servlet-debug
COPY moesif-servlet-debug-example moesif-servlet-debug-example

RUN cd moesifapi-java && mvn install -DskipTests
RUN cd moesif-servlet-debug && mvn install -DskipTests
RUN cd moesif-servlet-debug-example && mvn install -DskipTests
